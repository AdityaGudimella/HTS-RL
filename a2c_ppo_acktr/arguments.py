...
def get_args():
    ...
    parser.add_argument("--num-actors", type=int, default=1, help="1")
    parser.add_argument(
        "--num-steps",
        type=int,
        default=512,
    ...
    parser.add_argument(
        "--ppo-epoch", type=int, default=2, help="number of ppo epochs (default: 4)"
    )
    parser.add_argument(
        "--num-mini-batch",
        type=int,
